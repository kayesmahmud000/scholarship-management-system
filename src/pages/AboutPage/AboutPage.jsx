...
<img
       ...
       <div className='my-10 text-center lg:text-start'>
           ...
           <ul>
    <li> <span className="text-purple-600 font-semibold">Scholarship Exploration </span> – Browse through a wide range of scholarships tailored to your needs.</li>
    <li> <span className="text-purple-600 font-semibold"> Easy Application Process</span> O – Submit applications effortlessly in a few simple steps.</li>
    <li> <span className="text-purple-600 font-semibold"> Application Tracking</span>  – Monitor the progress of your submissions in real-time.
    </li>
    <li> <span className="text-purple-600 font-semibold"> Secure & Efficient Management </span> – Institutions and sponsors can manage applications and awards hassle-free.</li>
    <li> <span className="text-purple-600 font-semibold"> Seamless Communication</span> – Stay informed with updates and notifications.</li>
</ul>
    ...
    <li> ✅ Comprehensive Support – Our team is dedicated to assisting you at every step.</li>
       ...
       <div className='my-10 text-center lg:text-start'>
           ...
           <p className='my-5' >
           At
           <span className="text-purple-600 font-semibold"> Scholar Track Pro</span> cwe are committed to shaping a future where education is accessible to all. Whether you're a student looking for financial aid or an organization wanting to make a difference, our platform is here to support you.</p>
