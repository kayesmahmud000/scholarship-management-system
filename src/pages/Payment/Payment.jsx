...
const Payment = () => {
    ...
    return (
        <div className="flex justify-center text-center items-center min-h-screen ">
                <PageHelmet title={'Payment | Scholar Track Pro'}/>
       <div className="flex flex-col max-w-md shadow-2xl sm:p-10 bg-[#2C2536] p-8 rounded-lg  border border-gray-600" data-aos="zoom-in"
