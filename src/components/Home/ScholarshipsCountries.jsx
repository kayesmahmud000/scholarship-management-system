                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5  mx-auto gap-3 p-5">
                    {
                        ...
                        <div 
                            key={country._id} 
                            className="px-7 py-5 bg-white h-[100px] lg:h-[180px]  rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105 text-center"
                          >
                            <img 
                              src={country?.flag} 
                            ...
                            />
                            <h3 className="mt-4 text-xs lg:text-lg font-semibold text-gray-700">{country?.country}</h3>
                          </div>
                        </Link>
